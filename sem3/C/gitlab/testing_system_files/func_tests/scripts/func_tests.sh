...
while [[ $( find ./func_tests/data -name "pos_0${i}_in.txt" | wc -l ) == 1 && 
    ...
    ./func_tests/scripts/pos_case.sh "./func_tests/data/pos_0${i}_in.txt" "./func_tests/data/pos_0${i}_out.txt" "./func_tests/data/pos_0${i}_args.txt"
    exit_test=$?
    if [ "$exit_test" == 0 ]; then
        echo "OK"
    else
...
while [[ $( find ./func_tests/data -name "pos_${i}_in.txt" | wc -l ) == 1 && 
    ...
    echo "pos_${i}_in.txt"
    # ./func_tests/scripts/pos_case.sh "./func_tests/data/pos_0${i}_in.txt" "./func_tests/data/pos_0${i}_out.txt"
    ./func_tests/scripts/pos_case.sh "./func_tests/data/pos_${i}_in.txt" "./func_tests/data/pos_${i}_out.txt" "./func_tests/data/pos_${i}_args.txt"
    exit_test=$?
    if [ "$exit_test" == 0 ]; then
        echo "OK"
    else
...
while [[ $( find ./func_tests/data -name "neg_0${i}_args.txt" | wc -l ) == 1 ]]; do
    ...
    ./func_tests/scripts/neg_case.sh "./func_tests/data/neg_0${i}_in.txt" "./func_tests/data/neg_0${i}_args.txt"
    exit_test=$?
    if [ "$exit_test" == 0 ]; then
        echo "OK"
    else
...
while [[ $( find ./func_tests/data -name "neg_${i}_args.txt" | wc -l ) == 1 ]]; do
    ...
    echo "neg_${i}_in.txt"
    # ./func_tests/scripts/neg_case.sh "./func_tests/data/neg_0${i}_in.txt"
    ./func_tests/scripts/neg_case.sh "./func_tests/data/neg_${i}_in.txt" "./func_tests/data/neg_${i}_args.txt"
    exit_test=$?
    if [ "$exit_test" == 0 ]; then
        echo "OK"
    else
