...
int make_compare_table_stack_tree(enode_t *tree, lnode_t *stack)
{
    ...
    int len_t = 500;
    long long tree_calc_time, stack_calc_time, for_calc_time;
    double koef_bigger;
    ...
    koef_bigger = stack_calc_time / tree_calc_time;

    ft_printf_ln(tab, "%lld|%lld|%.2lf", tree_calc_time, stack_calc_time, koef_bigger);
